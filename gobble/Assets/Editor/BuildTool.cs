// Builds GOBBLE entirely from code (scene constructed here; no hand-authored YAML).
using System;
using UnityEditor;
...
public static class BuildTool
{
    ...
    {
        PlayerSettings.productName = "Gobble";
    ...
    public static void BuildWindows()
    {
        ...
        {
            BuildScene(); ConfigurePlayer();
            var r = BuildPipeline.BuildPlayer(new BuildPlayerOptions { scenes = new[] { ScenePath }, locationPathName = "Builds/Windows/Gobble.exe", target = BuildTarget.StandaloneWindows64, options = BuildOptions.None });
            Report("Windows", r);
        }
        catch (Exception e) { Debug.LogError("BUILD EXCEPTION: " + e); EditorApplication.Exit(2); }
    }
