// Builds STAK entirely from code (scene constructed here; no hand-authored YAML).
using System;
using UnityEditor;
...
public static class BuildTool
{
    ...
    {
        PlayerSettings.productName = "Stak";
    ...
    public static void BuildWindows()
    {
        ...
        {
            BuildScene(); ConfigurePlayer();
            var r = BuildPipeline.BuildPlayer(new BuildPlayerOptions { scenes = new[] { ScenePath }, locationPathName = "Builds/Windows/Stak.exe", target = BuildTarget.StandaloneWindows64, options = BuildOptions.None });
            Report("Windows", r);
        }
        catch (Exception e) { Debug.LogError("BUILD EXCEPTION: " + e); EditorApplication.Exit(2); }
    }
